  ...
  games: [
    {
      ...
      description: 'استعد التوازن في 30 ثانية: اغرس شتلة، أضف ديداناً، أعد البوم، نقِّ النهر',
      points: 35,
      gameData: {
        collectItems: ['🌱', '🪱', '🦉', '💧'],
        hazardItems: ['🏭', '🗑️', '🔥', '🪓'],
    ...
    },
    {
      ...
      description: 'اختر الإجراءات الصحيحة: منع قطع الشجرة، جمع النفايات، إخماد النار',
      points: 30,
      gameData: {
