  ...
  exercisesV2: [
    {
      ...
      points: 20,
      prompt: 'رتب مسار الطاقة من المصدر. ارسم الأسهم بذهنك: الطاقة لا تعود للوراء! ☀️➡️🦉',
      items: [
      ...
      successMessage: 'رائع! أنت "رائد دراسة الطاقة"! 🏅 الطاقة تسير في اتجاه واحد.',
      errorMessage: 'انتبه! الطاقة تبدأ من الشمس وتنتقل للمستهلكين، ولا تعود للخلف.',
      rewardBadge: { name: 'رائد دراسة الطاقة', icon: '⚡' },
    },
    {
      id: 'ex2',
      type: 'scenario',
      title: 'لماذا لا ينتهي الماء (والمادة)؟',
      points: 20,
      prompt: 'ما هي الخطوات الصحيحة لعودة المادة للطبيعة بعد موت كائن حي؟ 💀🔄',
      scenario: 'جثة حيوان في الغابة... كيف تعود للتربة؟',
      options: [
        'تأتي البكتيريا وتفكك الجثة وتعيدها معادن للتربة ✅',
        'تختفي المادة ولا يبقى منها شيء',
        'تتحول الجثة إلى صخور فوراً',
      ],
      correct: 'تأتي البكتيريا وتفكك الجثة وتعيدها معادن للتربة ✅',
      successMessage: 'أحسنت! أنت "خبير إعادة التدوير الطبيعي"! ♻️ البكتيريا هي السر.',
      errorMessage: 'المادة لا تختفي! البكتيريا (المفككات) تعيدها للنظام.',
      rewardBadge: { name: 'خبير التدوير', icon: '♻️' },
    },
    {
      id: 'ex3',
      type: 'mcq-set',
      title: 'اختر السلسلة الصحيحة!',
      points: 25,
      prompt: 'حدد السلسلة الغذائية الكاملة والصحيحة علمياً 🧬',
      questions: [
        {
          id: 'q1',
          question: 'أي السلاسل التالية صحيحة؟',
          options: [
            'نبات 🌿 ← فأر 🐭 ← بوم 🦉 ← بكتيريا 🦠',
            'شمس ☀️ ← نبات 🌿 ← بوم 🦉 (بدون مستهلك أول)',
            'بكتيريا 🦠 ← نبات 🌿 ← فأر 🐭 (البكتيريا في النهاية)',
          ],
          correct: 'نبات 🌿 ← فأر 🐭 ← بوم 🦉 ← بكتيريا 🦠',
        },
      ],
      successMessage: 'مذهل! أنت "حِرفي السلاسل الغذائية"! 🔗',
      errorMessage: 'تذكر: منتج ← مستهلك أول ← مستهلك ثاني ← مفكك.',
      rewardBadge: { name: 'حِرفي السلاسل', icon: '🔗' },
    },
  ],
  games: [
    {
