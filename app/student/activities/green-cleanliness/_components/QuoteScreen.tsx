    ...
    return (
        <div className="w-full max-w-4xl mx-auto text-center p-6" dir="rtl">
            ...
            <motion.div
                ...
                className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-3xl shadow-2xl p-12 md:p-16 mb-8"
            >
                <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                >
                    "الطفل الذي يحافظ على بيئته اليوم، يبني غدًا أنظف وأجمل."
                </motion.p>
            </motion.div>
