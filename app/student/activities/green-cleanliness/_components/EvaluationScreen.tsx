...
const indicators = [
    ...
    { id: 'role_respect', label: 'احترام الدور' },
    { id: 'cooperation', label: 'التعاون' },
    { id: 'safety', label: 'السلامة' },
    { id: 'continuity', label: 'الاستمرارية' }
];
...
const reflectionQuestions = [
    {
        id: 'feeling',
        question: 'كيف شعرت بعد هذا النشاط؟',
        placeholder: 'اكتب إجابتك هنا...'
    },
    {
        id: 'learning',
        question: 'ماذا تعلمت من هذا النشاط؟',
        placeholder: 'اكتب إجابتك هنا...'
    }
];
