...
export const climaticFactorsGrade5: Course = {
  ...
  games: [
    ...
    // 🎮 GAME 2: "رحلة الكائنات" (Creatures Journey) - لعبة تفاعلية احترافية للأطفال
    {
      id: 'g2',
      type: 'creatures-journey',
      title: 'رحلة الكائنات',
      description: 'ساعد الكائنات للوصول إلى مناخها المناسب! انقر على كائن ثم على المنطقة المناخية الصحيحة. عندما تضع جميع الكائنات في مكانها الصحيح، ستنتهي الرحلة بنجاح! 🌍🐪🌳✨',
      points: 50,
      gameData: {
        maxLevels: 3,
        climates: [
