...
interface Question {
  ...
  correct: string; // always 'A' per spec
}
...
const questions5: Question[] = [
  {
    id: 'q1',
    text: 'لماذا يُعد البلاستيك و"الميكروبلاستيك" خطراً كوكبياً على الصحة والغذاء؟',
    options: [
      { id: 'A', text: 'لأن البلاستيك يتحول لميكروبلاستيك يدخل السلسلة الغذائية ويصل للإنسان' },
      { id: 'B', text: 'لأنه ثقيل ويغرق في البحر فقط' },
      { id: 'C', text: 'لأنه يذوب في المطر ولا يبقى في البيئة' },
    ],
    correct: 'A',
  },
  {
    id: 'q2',
    text: 'ما القرار الأخلاقي الصحيح بين قطع الغابات والتنمية الاقتصادية السريعة؟',
    options: [
      { id: 'A', text: 'حماية الغابات لأنها رئة كوكب وتخزن الكربون وتحمي المناخ' },
      { id: 'B', text: 'قطع الغابات لبناء مصانع أكثر مهما كان الثمن' },
      { id: 'C', text: 'ترك الأمر للسوق دون قوانين بيئية' },
    ],
    correct: 'A',
  },
  {
    id: 'q3',
    text: 'لماذا يؤدي اختفاء النحل إلى أزمة غذاء عالمية؟',
    options: [
      { id: 'A', text: 'لأن النحل يلقح أغلب المحاصيل، واختفاؤه يهدد الأمن الغذائي' },
      { id: 'B', text: 'لأن النحل يستهلك العسل فقط' },
      { id: 'C', text: 'لأنه يسبب الضجيج في المدن' },
    ],
    correct: 'A',
  },
  {
    id: 'q4',
    text: 'ما المشكلة الكوكبية في نفايات الإلكترونيات؟',
    options: [
      { id: 'A', text: 'تحتوي معادن سامة تلوث الهواء والماء وتضر المجتمعات الفقيرة' },
      { id: 'B', text: 'آمنة ويمكن رميها في أي مكان' },
      { id: 'C', text: 'تختفي تلقائياً بعد شهرين' },
    ],
    correct: 'A',
  },
  {
    id: 'q5',
    text: 'لماذا تنظيف الشواطئ وحده لا يكفي لحل تلوث البلاستيك؟',
    options: [
      { id: 'A', text: 'لأن الحل في تقليل الإنتاج والمنع عند المصدر وليس جمع النفايات فقط' },
      { id: 'B', text: 'لأنه يفسد المنظر فقط' },
      { id: 'C', text: 'لأن البحر ينظف نفسه دائماً' },
    ],
    correct: 'A',
  },
  {
    id: 'q6',
    text: 'كيف يؤثر ارتفاع مستوى البحر على البشر؟',
    options: [
      { id: 'A', text: 'يؤدي لغرق مدن وهجرة مناخية وفقدان منازل' },
      { id: 'B', text: 'لا تأثير لأنه بطيء جداً' },
      { id: 'C', text: 'يجعل الشواطئ أوسع للسباحة' },
    ],
    correct: 'A',
  },
  {
    id: 'q7',
    text: 'لماذا يُعد الماء أزمة عالمية وليست محلية فقط؟',
    options: [
      { id: 'A', text: 'لأن الماء حق إنساني، ونقصه يسبب نزاعات وهجرة ومرض' },
      { id: 'B', text: 'لأن المياه المالحة تكفي للشرب' },
      { id: 'C', text: 'لأن المطر دائم في كل مكان' },
    ],
    correct: 'A',
  },
  {
    id: 'q8',
    text: 'ما دور المحميات الطبيعية مثل بوهدمة في حماية المناخ؟',
    options: [
      { id: 'A', text: 'تخزن الكربون وتحمي التنوع البيولوجي وتمنع الانقراض' },
      { id: 'B', text: 'تمنع دخول الأطفال فقط' },
      { id: 'C', text: 'تزيد الصيد الجائر' },
    ],
    correct: 'A',
  },
  {
    id: 'q9',
    text: 'أي خيار عائلي يقلل الانبعاثات اليومية؟',
    options: [
      { id: 'A', text: 'تقاسم السيارة أو استخدام النقل العام بدل شراء سيارة ثانية' },
      { id: 'B', text: 'تشغيل المحرك أثناء الانتظار' },
      { id: 'C', text: 'القيادة بسرعة لنوفر الوقت' },
    ],
    correct: 'A',
  },
  {
    id: 'q10',
    text: 'ما معنى مبدأ "المسؤولية المشتركة لكن المتباينة" في المناخ؟',
    options: [
      { id: 'A', text: 'الدول الملوِّثة أكثر تتحمل نصيباً أكبر من الحلول والتمويل' },
      { id: 'B', text: 'كل الدول متساوية مهما كانت انبعاثاتها' },
      { id: 'C', text: 'الدول الفقيرة وحدها تتحمل المسؤولية' },
    ],
    correct: 'A',
  },
];
...
const computeCategory5 = (score: number) => {
  if (score >= 8) return '🌍 خبير بيئي كوكبي';
  if (score >= 5) return '🌱 محلل بيئي';
  return '🐾 مبتدئ ناقد';
};

const computeCategory6 = (score: number) => {
  if (score >= 10) return '🌍🌎 خبير بيئي عالمي';
  if (score >= 6) return '🔍 محلل بيئي ناقد';
  return '🌱 مبتدئ واعٍ';
};
...
export default function LevelTestPage() {
  ...
  useEffect(() => {
    ...
    const checkStatus = async () => {
      try {
        ...
        console.error('Failed to load level-test status', e);
      } finally {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await levelTestAPI.submit({
      ...
      console.error(e);
      setError(e.message || 'فشل حفظ النتيجة. حاول مجدداً.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  if (loading || statusLoading || !normalizedLevel || !user) {
    return <EcoLoading message="تحميل الاختبار التشخيصي..." />;
  }
          ...
          <CardContent className="p-6 space-y-6">
            <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-gray-800">{result.level === '5eme' ? 'السنة الخامسة' : 'السنة السادسة'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">النتيجة</p>
                <p className="text-2xl font-extrabold text-green-700">{result.score}/{result.level === '5eme' ? 10 : 12}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">التصنيف</p>
                <p className="text-xl font-bold text-amber-700">{result.category}</p>
              </div>
            </div>

            <div className="flex items-center gap-3 text-sm text-gray-600">
              <Trophy className="w-5 h-5 text-amber-500" />
              <span>يمكنك تغيير المستوى لاحقاً من الإعدادات لإعادة الاختبار لمستوى آخر.</span>
            </div>

            <div className="flex justify-end">
              <Button
                className="rounded-2xl px-6 py-3 font-bold bg-green-600 hover:bg-green-700 text-white"
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-amber-50 to-sky-50 flex items-center justify-center p-4" dir="rtl">
      <Card className="w-full max-w-4xl border-4 border-green-200 shadow-2xl rounded-3xl overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-green-100 to-amber-100 border-b-2 border-green-200">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-2xl text-gray-800">
                  🧠🎓 اختبار تشخيصي إلزامي - {normalizedLevel === '5eme' ? 'السنة الخامسة' : 'السنة السادسة'}
                </CardTitle>
            ...
            <div className="flex items-center gap-2 text-sm font-bold text-red-600">
              ...
              <span>لا رجوع بعد الاختيار، ولا يمكن تخطي الاختبار</span>
            </div>
          </div>
          <div className="mt-3">
            <Progress value={progressPercent} className="h-2" />
            <div className="text-xs text-gray-700 mt-1">السؤال {currentIdx + 1} / {totalQuestions}</div>
          </div>
        </CardHeader>
        ...
        <CardContent className="p-6 space-y-6">
          {currentQuestion && (
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-green-700 font-extrabold text-lg shadow">
                  {currentIdx + 1}
                </div>
              ...
              {currentAnswer && (
                <div className={`flex items-center gap-2 text-sm font-bold ${currentAnswer.correct ? 'text-green-700' : 'text-red-700'}`}>
                  {currentAnswer.correct ? <CheckCircle className="w-5 h-5" /> : <ShieldAlert className="w-5 h-5" />}
                  {currentAnswer.correct ? 'إجابة صحيحة!' : 'إجابة غير صحيحة. المتابعة للسؤال التالي.'}
                </div>
              )}
            </div>
          )}
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            {currentIdx < totalQuestions - 1 ? (
              ...
              <Button
                ...
                disabled={answers.length !== totalQuestions || submitting}
                className="rounded-2xl px-6 py-3 font-bold bg-green-600 hover:bg-green-700 text-white"
              >
                {submitting ? 'جاري الحفظ...' : 'إنهاء الاختبار وحفظ النتيجة'}
              </Button>
            )}
          </div>

          {error && (
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-3 text-sm text-red-700 font-bold">
              {error}
            </div>
          )}
          ...
          <div className="flex items-center gap-3 text-sm text-gray-600">
            <Trophy className="w-5 h-5 text-amber-500" />
            <span>التصنيف يُحسب تلقائياً حسب مجموع الإجابات الصحيحة.</span>
          </div>
        </CardContent>
      </Card>
    </div>
